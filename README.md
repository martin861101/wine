...
The `ai-chat` function records Gemini failure statuses and provider error bodies in server-side logs for diagnostics; API keys and other configured secrets are never logged.
